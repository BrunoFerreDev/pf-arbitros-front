<template>
  <div
    class="bg-white border border-slate-200 p-5 flex flex-col gap-5 shadow-sm"
  >
    <div class="flex justify-between items-start">
      <div class="flex items-center gap-2">
        <span
          class="px-2 py-1 bg-red-500/10 text-red-500 text-[10px] font-bold uppercase tracking-wider rounded border border-red-500/20"
          >En Vivo - 74'</span
        >
        <span
          class="px-2 py-1 bg-slate-100 text-slate-600 text-[10px] font-bold uppercase tracking-wider rounded"
    ...
    <div class="flex items-center justify-between px-4">
      <div class="flex flex-col items-center gap-3 flex-1 text-center">
        ...
        <div
          class="size-16 bg-slate-100 rounded-full flex items-center justify-center p-2"
        >
          <div
            class="w-full h-full bg-contain bg-no-repeat bg-center"
            data-alt="Escudo Arsenal"
            style="
        ...
        <p class="font-bold text-sm">Arsenal</p>
      </div>
      <div class="flex flex-col items-center gap-1">
        <p class="text-3xl font-black">2 - 1</p>
      ...
      <div class="flex flex-col items-center gap-3 flex-1 text-center">
        ...
        <p class="font-bold text-sm">Liverpool</p>
      </div>
    </div>
    <div class="pt-4 border-t border-slate-100 flex gap-3">
      <button
        @click.prevent="navigateTo('/partido')"
      ...
      <button
        class="px-4 py-2.5 bg-slate-100 text-slate-600 rounded-lg text-sm font-bold"
      >
        Detalles
      </button>
    </div>
